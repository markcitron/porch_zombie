...
try:
	...
	Motor1.TurnStep(Dir='forward', steps=400, stepdelay = 0.005)
	time.sleep(0.5)
	...
	Motor1.TurnStep(Dir='forward', steps=2048, stepdelay=0.0001)
	time.sleep(0.5)
	Motor1.TurnStep(Dir='backward', steps=2048, stepdelay=0.0001)
	Motor1.Stop()
