...
# 🛠️ Servo Setup
pan_servo = Servo(8)   # Left/right movement; +45 = counterclockwise (left), -45 = clockwise (right)
tilt_servo = Servo(7)  # Up/down movement; -45 = upward, +45 = downward

# reset the servos to start things off
pan_servo.angle(0)
tilt_servo.angle(0)
